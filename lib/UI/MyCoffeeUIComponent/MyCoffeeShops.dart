...
class MyCoffeeShops extends StatefulWidget {

  @override
  State<StatefulWidget> createState() => _MyCoffeeShops();
}

class _MyCoffeeShops extends State<MyCoffeeShops> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance
        .collection('coffee').where('user_id', isEqualTo: json['uid']).orderBy('timestamp', descending: true)
        .snapshots()
        .listen((event) {
      myCoffee.clear();
        ...
        body: ModalProgressHUD(
            ...
            child: (myCoffee.isNotEmpty) ? Container(
                ...
                child: ListView.builder(
                      ...
                      actionExtentRatio: 0.25,
                        secondaryActions: <Widget>[
                          new IconSlideAction(
                            ...
                            icon: Icons.delete,
                            onTap: () async {
                              await FirebaseFirestore.instance.collection('coffee').doc(myCoffee[position].id).delete();
                              // setState(() {
                  ...
                  //   ...coffeeBuilder(),
                  // ],
                )) : EmptyCoffeeShop("No Coffee Shops created yet!")));
  }
